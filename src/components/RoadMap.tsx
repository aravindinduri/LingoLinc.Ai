    ...
    <div className="p-4">
      ...
      <div className="flex flex-col items-center">
        {[...Array(days).keys()].map(day => (
          <Box key={day} display="flex" flexDirection="column" alignItems="center">
            <PathStep
              step={{ id: day + 1, x: 0, y: 0 }} // Adjust based on your path layout
              completedDays={completedDays[language] || 0} // Use default value to avoid undefined
              handleLessonClick={handleStepClick}
            >
              Day {day + 1} {/* Pass Day {day + 1} as children */}
            </PathStep>
            {day < days - 1 && (
              <div className="path-line" />
            )}
